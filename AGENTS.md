...
This section describes a **Next.js 15 full-stack application** for AI-powered flashcard learning (FlashMaster template), not SereneMind. Use it only for general Azure OpenAI / Next.js patterns.
